...
@section('content')
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            @foreach ($dishes as $dish)
                <div class="col">
                    <div class="card h-100 {{$dish->visible ? 'bg-light' : 'border-danger'}}">
                        <div class="row g-0">
                            <div class="col-md-4">
                                ...
                                {{-- DELETE --}}
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#delete-modal-{{$dish->id}}" class="mx-1">
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                              ...
                                              {{-- Delete Form --}}
                                              {{-- <form action="{{route('admin.dish.destroy', $restaurant)}}" method="POST" class="mx-1"> --}}
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><small class="fw-bold">Prezzo: {{ $dish->price }}€</small>
                                    </p>
                                    @if (!$dish->visible)
                                        <p class="card-text">
                                            <small class="fw-bold text-danger">Non disponibile</small>
                                        </p>
                                    @endif
                                </div>
                            </div>
